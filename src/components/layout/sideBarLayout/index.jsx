    ...
    <ContentWrapper isHamburguerOpen={isHamburguerOpen}>
      ...
      <RotatingWrapper isFlipped={isFlipped} vector={horizontalVector}>
        <FrontFace>
          ...
          <ScrollableMenuArea>
            <div style={{ width: "260px", border: "solid 1px #374151", marginTop: "20px", marginBottom: "10px" }}></div>
            <Menu>
              <ul>
                <li>
                  <Span
          ...
          <div style={{ width: "260px", border: "solid 1px #374151", marginBottom: "10px" }}></div>
          <FlipButtonContainer>
        ...
        <BackFace>
          ...
          <TitleName onClick={cliqueSecreto}>Build App</TitleName>
          <SubTitle>Do Zero ao Deploy</SubTitle>
          <div style={{ width: "260px", border: "solid 1px #374151", marginTop: "20px", marginBottom: "10px" }}></div>
          <Menu>
            <ul>
              <li>
