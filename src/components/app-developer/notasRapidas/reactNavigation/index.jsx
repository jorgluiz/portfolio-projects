...
const FunctionNames = () => {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags Atualizados para "Convenções de Nomenclatura" */}
        <title>Convenções de Nomenclatura em React: Guia de Clean Code para Funções</title>
        <meta
          name="description"
          content="Aprenda os padrões de nomenclatura para funções em React e React Native. Use 'handle' para eventos, 'fetch' para APIs, 'is/has' para validações e melhore a legibilidade do seu código."
        />
        <meta
          name="keywords"
          content="React, React Native, Convenções de Nomenclatura, Clean Code, Padrões de Código, Funções, handle, fetch, format, is, has, JavaScript"
        />
        ...
        <meta property="og:title" content="Convenções de Nomenclatura em React: Guia de Clean Code para Funções" />
        <meta property="og:description" content="Escreva um código React mais limpo e legível. Este guia cobre as melhores práticas para nomear funções, incluindo manipuladores de eventos (handle), buscas de dados (fetch) e mais." />
        ...
        <meta property="twitter:title" content="Convenções de Nomenclatura em React: Guia de Clean Code para Funções" />
        <meta property="twitter:description" content="Melhore seu código React! Aprenda as convenções de nomenclatura essenciais para funções (handle*, fetch*, is*, format*) e torne seus componentes mais fáceis de manter." />
